...
with open("/kuacc/users/mugekural/workfolder/dev/tur/tur_filtered_duplicates_merged_stdata_NOUNS", "w") as writer:
...
with open("/kuacc/users/mugekural/workfolder/dev/git/unsup-morph-vqvae/src/dataset/tur.dev_NOUNS", "w") as writer:
    for word, line in words.items():
        writer.write(line)
...
with open("/kuacc/users/mugekural/workfolder/dev/git/unsup-morph-vqvae/src/dataset/tur.gold_NOUNS", "w") as writer:
    for word, line in words.items():
        writer.write(line)
