...
class VQVAE(nn.Module):
    def __init__(self):
        ...
        self.linear_affix_1 = nn.Linear(Z_NH, Z_NH)
        self.linear_affix_2 = nn.Linear(Z_NH, Z_NH)

        self.quantizer_lemma = Quantizer(NUM_ENTRY_LEMMA)
        self.quantizer_affix_1 = Quantizer(NUM_ENTRY_AFFIX)
        self.quantizer_affix_2 = Quantizer(NUM_ENTRY_AFFIX)
    ...
    def forward(self, x: torch.Tensor):
        ...
        z_affix_1 = self.linear_affix_1(z)
        z_affix_2 = self.linear_affix_2(z)
        ...
        quantized_z_affix_1, quantized_indices_affix_1, qloss_affix_1 = self.quantizer_affix_1(z_affix_1)
        quantized_z_affix_2, quantized_indices_affix_2, qloss_affix_2 = self.quantizer_affix_2(z_affix_2)
        
        quantized_z = torch.add(quantized_z_lemma, quantized_z_affix_1)
        quantized_z = torch.add(quantized_z, quantized_z_affix_2)
        ...
        Q_affix_1 = torch.sum(qloss_affix_1)
        Q_affix_2 = torch.sum(qloss_affix_2)
        Q_affix = Q_affix_1 + Q_affix_2
        return totalloss, nonpadded_tokens, pred_tokens, (Q_lemma, Q_affix), (quantized_indices_lemma, quantized_indices_affix_1, quantized_indices_affix_2)
