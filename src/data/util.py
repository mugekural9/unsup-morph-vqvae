...
trn_unique_lemmas_df.to_csv('data/trn_unique_lemmas.csv')
trn_unique_tgts_df.to_csv('data/trn_unique_tgts.csv')
...
dev_unique_lemmas_df.to_csv('data/dev_unique_lemmas.csv')
dev_unique_tgts_df.to_csv('data/dev_unique_tgts.csv')
...
for lemma,v in dev_unique_lemmas_dict.items():
    if lemma in trn_unique_lemmas_dict:
        ...
        idx+=1
lemma_seen_in_trn.to_csv('data/dev_lemma_seen_in_trn.csv')
...
for tgt,v in dev_unique_tgts_dict.items():
    if tgt in trn_unique_tgts_dict:
        ...
        idx+=1
        print('hello')
tgt_seen_in_trn.to_csv('data/dev_tgt_seen_in_trn.csv')