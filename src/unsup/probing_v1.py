...
def config(PROBE_KEY, PROBING_TYPE, CODEBOOK_ID, TAG_ID, logger):
    ...
    model.load_state_dict(torch.load("/kuacc/users/mugekural/workfolder/dev/git/unsup-morph-vqvae/src/results/vqvae_noinductivebias/unsup/verbs/run"+RUN_NAME+"_"+DICT_NAME+"_zLEM100_zTAG128_decnh1024_kl"+KL_NAME+"_epc10_strt5_decdo0.2_inpemb128_bsize64/vqvae_"+EPC_NAME+".pt"))
    model.eval()
